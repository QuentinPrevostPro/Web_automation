def mkdiruby
    ...
    Dir.mkdir("#{ARGV.join(" ")}/lib/app")
    Dir.mkdir("#{ARGV.join(" ")}/lib/views")
    Dir.mkdir("#{ARGV.join(" ")}/db")
    app = File.open("#{ARGV.join(" ")}/app.rb", "w")
    views = File.open("#{ARGV.join(" ")}/lib/views/done.rb", "w")
    index = File.open("#{ARGV.join(" ")}/lib/views/index.rb", "w")
